    ...
    <div className="Tarifs page-container page-section-grey">
      ...
      <div className="politque-paiement pageCustom-content container-2 mb100">
        ...
        <div className="text conditions-text">
          ...
          <ul>
            <li>
              les sites Web Adobe ; les services en ligne tels que Behance, ainsi que les éléments
              en ligne de Creative Cloud, de Document Cloud et d’Experience Cloud (communément
              désignés par « sites Web ») ;
            </li>
            <li>
              les sites Web Adobe ; les services en ligne tels que Behance, ainsi que les éléments
              en ligne de Creative Cloud, de Document Cloud et d’Experience Cloud (communément
