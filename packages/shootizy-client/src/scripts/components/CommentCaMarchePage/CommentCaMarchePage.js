  ...
  <Layout>
    <article className="CommentCaMarchePageWrapper">
      ...
      <div className="text container-2">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis leo ex, scelerisque vel
          turpis vitae, scelerisque condimentum elit. Vestibulum rutrum ultrices blandit. Etiam
          condimentum tincidunt felis non tempor. Integer luctus, orci vel viverra posuere, dolor
          felis feugiat dolor, ac tincidunt neque eros in sem. Suspendisse et nisl nunc. Nullam sed
          purus venenatis, sagittis neque non, porta nibh. Lorem ipsum dolor sit amet, consectetur
          adipiscing elit. Praesent tincidunt sapien eget quam tempus faucibus.
        </p>
        ...
        <p>
          ...
          feugiat. Suspendisse pulvinar pharetra risus eget sollicitudin. Interdum et malesuada
          fames ac ante ipsum primis in faucibus. Sed pharetra suscipit gravida. Mauris porttitor,
          tellus vitae vehicula gravida, est nunc facilisis purus, vel pretium lorem diam id urna.
          Donec facilisis eget quam in posuere. In id ultrices dui.
        </p>
      </div>
